...
public class BlockModelGenerators {
    ...
    private void createStems(Block block, Block block2) {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(block).with(PropertyDispatch.property(BlockStateProperties.AGE_7).generate(n -> Variant.variant().with(VariantProperties.MODEL, ModelTemplates.STEMS[n].create(block, textureMapping, this.modelOutput)))));
    }
    ...
    private void createActiveRail(Block block) {
        ...
        PropertyDispatch propertyDispatch = PropertyDispatch.properties(BlockStateProperties.POWERED, BlockStateProperties.RAIL_SHAPE_STRAIGHT).generate((bl, railShape) -> {
            switch (railShape) {
                case NORTH_SOUTH: {
                    return Variant.variant().with(VariantProperties.MODEL, bl != false ? resourceLocation4 : resourceLocation);
                }
                case EAST_WEST: {
                    return Variant.variant().with(VariantProperties.MODEL, bl != false ? resourceLocation4 : resourceLocation).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90);
                }
                case ASCENDING_EAST: {
                    return Variant.variant().with(VariantProperties.MODEL, bl != false ? resourceLocation5 : resourceLocation2).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90);
                }
                case ASCENDING_WEST: {
                    return Variant.variant().with(VariantProperties.MODEL, bl != false ? resourceLocation6 : resourceLocation3).with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90);
                }
                case ASCENDING_NORTH: {
                    return Variant.variant().with(VariantProperties.MODEL, bl != false ? resourceLocation5 : resourceLocation2);
                }
                case ASCENDING_SOUTH: {
                    return Variant.variant().with(VariantProperties.MODEL, bl != false ? resourceLocation6 : resourceLocation3);
                }
            }
    ...
    private void createColoredBlockWithRandomRotations(TexturedModel.Provider provider, Block ... arrblock) {
    ...
    private void createColoredBlockWithStateRotations(TexturedModel.Provider provider, Block ... arrblock) {
        for (Block block : arrblock) {
            ResourceLocation resourceLocation = provider.create(block, this.modelOutput);
    ...
    private void createCommandBlock(Block block) {
        ...
        ResourceLocation resourceLocation3 = this.createSuffixedVariant(block, "_conditional", ModelTemplates.COMMAND_BLOCK, resourceLocation -> textureMapping.copyAndUpdate(TextureSlot.SIDE, (ResourceLocation)resourceLocation));
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(block).with(BlockModelGenerators.createBooleanModelDispatch(BlockStateProperties.CONDITIONAL, resourceLocation3, resourceLocation2)).with(BlockModelGenerators.createFacingDispatch()));
    }
    ...
    private List<Variant> createBambooModels(int n2) {
        String string = "_age" + n2;
        return IntStream.range(1, 5).mapToObj(n -> Variant.variant().with(VariantProperties.MODEL, ModelLocationUtils.getModelLocation(Blocks.BAMBOO, n + string))).collect(Collectors.toList());
    }
    ...
    private void createCropBlock(Block block, Property<Integer> property, int ... arrn) {
        if (property.getPossibleValues().size() != arrn.length) {
            throw new IllegalArgumentException();
        }
        Int2ObjectOpenHashMap int2ObjectOpenHashMap = new Int2ObjectOpenHashMap();
        PropertyDispatch propertyDispatch = PropertyDispatch.property(property).generate(arg_0 -> this.lambda$createCropBlock$7(arrn, (Int2ObjectMap)int2ObjectOpenHashMap, block, arg_0));
        this.createSimpleFlatItemModel(block.asItem());
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(block).with(propertyDispatch));
    }
    ...
    private void createCampfires(Block ... arrblock) {
    ...
    private void createChorusFlower() {
        ...
        ResourceLocation resourceLocation3 = this.createSuffixedVariant(Blocks.CHORUS_FLOWER, "_dead", ModelTemplates.CHORUS_FLOWER, resourceLocation -> textureMapping.copyAndUpdate(TextureSlot.TEXTURE, (ResourceLocation)resourceLocation));
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.CHORUS_FLOWER).with(BlockModelGenerators.createEmptyOrFullDispatch(BlockStateProperties.AGE_5, 5, resourceLocation3, resourceLocation2)));
    }
    ...
    private void createFire() {
        Condition.TerminalCondition terminalCondition = Condition.condition().term(BlockStateProperties.NORTH, false).term(BlockStateProperties.EAST, false).term(BlockStateProperties.SOUTH, false).term(BlockStateProperties.WEST, false).term(BlockStateProperties.UP, false);
        ...
        this.blockStateOutput.accept(MultiPartGenerator.multiPart(Blocks.FIRE).with((Condition)terminalCondition, BlockModelGenerators.wrapModels(list, variant -> variant)).with(Condition.or(Condition.condition().term(BlockStateProperties.NORTH, true), terminalCondition), BlockModelGenerators.wrapModels(list2, variant -> variant)).with(Condition.or(Condition.condition().term(BlockStateProperties.EAST, true), terminalCondition), BlockModelGenerators.wrapModels(list2, variant -> variant.with(VariantProperties.Y_ROT, VariantProperties.Rotation.R90))).with(Condition.or(Condition.condition().term(BlockStateProperties.SOUTH, true), terminalCondition), BlockModelGenerators.wrapModels(list2, variant -> variant.with(VariantProperties.Y_ROT, VariantProperties.Rotation.R180))).with(Condition.or(Condition.condition().term(BlockStateProperties.WEST, true), terminalCondition), BlockModelGenerators.wrapModels(list2, variant -> variant.with(VariantProperties.Y_ROT, VariantProperties.Rotation.R270))).with((Condition)Condition.condition().term(BlockStateProperties.UP, true), BlockModelGenerators.wrapModels(list3, variant -> variant)));
    }
    ...
    private void createRepeater() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.REPEATER).with(PropertyDispatch.properties(BlockStateProperties.DELAY, BlockStateProperties.LOCKED, BlockStateProperties.POWERED).generate((n, bl, bl2) -> {
    ...
    private void createSnowBlocks() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.SNOW).with(PropertyDispatch.property(BlockStateProperties.LAYERS).generate(n -> Variant.variant().with(VariantProperties.MODEL, n < 8 ? ModelLocationUtils.getModelLocation(Blocks.SNOW, "_height" + n * 2) : resourceLocation))));
    ...
    private void createSweetBerryBush() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.SWEET_BERRY_BUSH).with(PropertyDispatch.property(BlockStateProperties.AGE_3).generate(n -> Variant.variant().with(VariantProperties.MODEL, this.createSuffixedVariant(Blocks.SWEET_BERRY_BUSH, "_stage" + n, ModelTemplates.CROSS, TextureMapping::cross)))));
    }
    ...
    private void createTripwireHook() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.TRIPWIRE_HOOK).with(PropertyDispatch.properties(BlockStateProperties.ATTACHED, BlockStateProperties.POWERED).generate((bl, bl2) -> Variant.variant().with(VariantProperties.MODEL, TextureMapping.getBlockTexture(Blocks.TRIPWIRE_HOOK, (bl != false ? "_attached" : "") + (bl2 != false ? "_on" : ""))))).with(BlockModelGenerators.createHorizontalFacingDispatch()));
    }

    private ResourceLocation createTurtleEggModel(int n, String string, TextureMapping textureMapping) {
        switch (n) {
            case 1: {
    ...
    private ResourceLocation createTurtleEggModel(Integer n, Integer n2) {
        switch (n2) {
            case 0: {
                return this.createTurtleEggModel(n, "", TextureMapping.cube(TextureMapping.getBlockTexture(Blocks.TURTLE_EGG)));
            }
            case 1: {
                return this.createTurtleEggModel(n, "slightly_cracked_", TextureMapping.cube(TextureMapping.getBlockTexture(Blocks.TURTLE_EGG, "_slightly_cracked")));
            }
            case 2: {
                return this.createTurtleEggModel(n, "very_cracked_", TextureMapping.cube(TextureMapping.getBlockTexture(Blocks.TURTLE_EGG, "_very_cracked")));
            }
        }
        throw new UnsupportedOperationException();
    }
    ...
    private void createTurtleEgg() {
        ...
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.TURTLE_EGG).with(PropertyDispatch.properties(BlockStateProperties.EGGS, BlockStateProperties.HATCH).generateList((n, n2) -> Arrays.asList(BlockModelGenerators.createRotatedVariants(this.createTurtleEggModel((Integer)n, (Integer)n2))))));
    }
    ...
    private void createRespawnAnchor() {
        ...
        ResourceLocation[] arrresourceLocation = new ResourceLocation[5];
        for (int i = 0; i < 5; ++i) {
            ...
            arrresourceLocation[i] = ModelTemplates.CUBE_BOTTOM_TOP.createWithSuffix(Blocks.RESPAWN_ANCHOR, "_" + i, textureMapping, this.modelOutput);
        }
        this.blockStateOutput.accept(MultiVariantGenerator.multiVariant(Blocks.RESPAWN_ANCHOR).with(PropertyDispatch.property(BlockStateProperties.RESPAWN_ANCHOR_CHARGES).generate(n -> Variant.variant().with(VariantProperties.MODEL, arrresourceLocation[n]))));
        this.delegateItemModel(Items.RESPAWN_ANCHOR, arrresourceLocation[0]);
    }
    ...
    public void run() {
        ...
        this.createCraftingTableLike(Blocks.CRAFTING_TABLE, Blocks.OAK_PLANKS, (arg_0, arg_1) -> TextureMapping.craftingTable(arg_0, arg_1));
        this.createCraftingTableLike(Blocks.FLETCHING_TABLE, Blocks.BIRCH_PLANKS, (arg_0, arg_1) -> TextureMapping.fletchingTable(arg_0, arg_1));
    ...
    private /* synthetic */ Variant lambda$createCropBlock$7(int[] arrn, Int2ObjectMap int2ObjectMap, Block block, Integer n) {
        int n3 = arrn[n];
        ResourceLocation resourceLocation = (ResourceLocation)int2ObjectMap.computeIfAbsent(n3, n2 -> this.createSuffixedVariant(block, "_stage" + n3, ModelTemplates.CROP, TextureMapping::crop));
    ...
    class BlockEntityModelGenerator {
        ...
        public BlockEntityModelGenerator create(Block ... arrblock) {
            for (Block block : arrblock) {
        ...
        public BlockEntityModelGenerator createWithoutBlockItem(Block ... arrblock) {
            for (Block block : arrblock) {
                BlockModelGenerators.this.skipAutoItemBlock(block);
            }
            return this.create(arrblock);
        }

        public BlockEntityModelGenerator createWithCustomBlockItemModel(ModelTemplate modelTemplate, Block ... arrblock) {
            for (Block block : arrblock) {
