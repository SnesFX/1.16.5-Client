...
public class ModelTemplates {
    ...
    public static final ModelTemplate[] STEMS = (ModelTemplate[])IntStream.range(0, 8).mapToObj(n -> ModelTemplates.create("stem_growth" + n, "_stage" + n, TextureSlot.STEM)).toArray(n -> new ModelTemplate[n]);
    ...
    private static ModelTemplate create(TextureSlot ... arrtextureSlot) {
        return new ModelTemplate(Optional.empty(), Optional.empty(), arrtextureSlot);
    }

    private static ModelTemplate create(String string, TextureSlot ... arrtextureSlot) {
        return new ModelTemplate(Optional.of(new ResourceLocation("minecraft", "block/" + string)), Optional.empty(), arrtextureSlot);
    }

    private static ModelTemplate createItem(String string, TextureSlot ... arrtextureSlot) {
        return new ModelTemplate(Optional.of(new ResourceLocation("minecraft", "item/" + string)), Optional.empty(), arrtextureSlot);
    }

    private static ModelTemplate create(String string, String string2, TextureSlot ... arrtextureSlot) {
        return new ModelTemplate(Optional.of(new ResourceLocation("minecraft", "block/" + string)), Optional.of(string2), arrtextureSlot);
    }
}
