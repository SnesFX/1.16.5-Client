...
extends DataFix {
    ...
    public TypeRewriteRule makeRule() {
        ...
        return this.fixTypeEverywhereTyped("ItemInstanceSpawnEggFix", type, typed -> {
            ...
            if (optional2.isPresent() && Objects.equals(((Pair)optional2.get()).getSecond(), "minecraft:spawn_egg") && (optional = (typed3 = (typed2 = typed.getOrCreateTyped(opticFinder3)).getOrCreateTyped(opticFinder4)).getOptional(opticFinder2)).isPresent()) {
