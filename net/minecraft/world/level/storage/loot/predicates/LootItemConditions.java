...
public class LootItemConditions {
    ...
    public static <T> Predicate<T> andConditions(Predicate<T>[] arrpredicate) {
        switch (arrpredicate.length) {
            case 0: {
                return object -> true;
            }
            case 1: {
                return arrpredicate[0];
            }
            case 2: {
                return arrpredicate[0].and(arrpredicate[1]);
            }
        }
        return object -> {
            for (Predicate predicate : arrpredicate) {
    ...
    public static <T> Predicate<T> orConditions(Predicate<T>[] arrpredicate) {
        switch (arrpredicate.length) {
            case 0: {
                return object -> false;
            }
            ...
            case 2: {
                return arrpredicate[0].or(arrpredicate[1]);
            }
        }
        return object -> {
            for (Predicate predicate : arrpredicate) {
