...
extends BlobFoliagePlacer {
    public static final Codec<FancyFoliagePlacer> CODEC = RecordCodecBuilder.create(instance -> FancyFoliagePlacer.blobParts(instance).apply((Applicative)instance, (arg_0, arg_1, arg_2) -> FancyFoliagePlacer.new(arg_0, arg_1, arg_2)));

    public FancyFoliagePlacer(UniformInt uniformInt, UniformInt uniformInt2, int n) {
