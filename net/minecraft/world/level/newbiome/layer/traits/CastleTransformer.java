...
DimensionOffset1Transformer {
    ...
    default public int applyPixel(BigContext<?> bigContext, Area area, int n, int n2) {
        return this.apply(bigContext, area.get(this.getParentX(n + 1), this.getParentY(n2 + 0)), area.get(this.getParentX(n + 2), this.getParentY(n2 + 1)), area.get(this.getParentX(n + 1), this.getParentY(n2 + 2)), area.get(this.getParentX(n + 0), this.getParentY(n2 + 1)), area.get(this.getParentX(n + 1), this.getParentY(n2 + 1)));
    }
}
