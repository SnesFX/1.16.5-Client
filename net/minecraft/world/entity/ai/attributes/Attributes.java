...
public class Attributes {
    ...
    public static final Attribute MOVEMENT_SPEED = Attributes.register("generic.movement_speed", new RangedAttribute("attribute.name.generic.movement_speed", 0.699999988079071, 0.0, 1024.0).setSyncable(true));
    public static final Attribute FLYING_SPEED = Attributes.register("generic.flying_speed", new RangedAttribute("attribute.name.generic.flying_speed", 0.4000000059604645, 0.0, 1024.0).setSyncable(true));
