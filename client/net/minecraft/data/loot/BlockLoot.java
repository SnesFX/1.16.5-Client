...
implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
    ...
    private static final Set<Item> EXPLOSION_RESISTANT = (Set)Stream.of(Blocks.DRAGON_EGG, Blocks.BEACON, Blocks.CONDUIT, Blocks.SKELETON_SKULL, Blocks.WITHER_SKELETON_SKULL, Blocks.PLAYER_HEAD, Blocks.ZOMBIE_HEAD, Blocks.CREEPER_HEAD, Blocks.DRAGON_HEAD, Blocks.SHULKER_BOX, Blocks.BLACK_SHULKER_BOX, Blocks.BLUE_SHULKER_BOX, Blocks.BROWN_SHULKER_BOX, Blocks.CYAN_SHULKER_BOX, Blocks.GRAY_SHULKER_BOX, Blocks.GREEN_SHULKER_BOX, Blocks.LIGHT_BLUE_SHULKER_BOX, Blocks.LIGHT_GRAY_SHULKER_BOX, Blocks.LIME_SHULKER_BOX, Blocks.MAGENTA_SHULKER_BOX, Blocks.ORANGE_SHULKER_BOX, Blocks.PINK_SHULKER_BOX, Blocks.PURPLE_SHULKER_BOX, Blocks.RED_SHULKER_BOX, Blocks.WHITE_SHULKER_BOX, Blocks.YELLOW_SHULKER_BOX).map(ItemLike::asItem).collect(ImmutableSet.toImmutableSet());
    ...
    private static <T extends Comparable<T> & StringRepresentable> LootTable.Builder createSinglePropConditionTable(Block block, Property<T> property, T t) {
        return LootTable.lootTable().withPool(BlockLoot.applyExplosionCondition(block, LootPool.lootPool().setRolls(ConstantIntValue.exactly(1)).add((LootPoolEntryContainer.Builder<?>)LootItem.lootTableItem(block).when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(block).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(property, t))))));
    }
    ...
    public void accept(BiConsumer<ResourceLocation, LootTable.Builder> biConsumer) {
        ...
        this.add(Blocks.STONE, block -> BlockLoot.createSingleItemTableWithSilkTouch(block, Blocks.COBBLESTONE));
        this.add(Blocks.GRASS_BLOCK, block -> BlockLoot.createSingleItemTableWithSilkTouch(block, Blocks.DIRT));
        this.add(Blocks.PODZOL, block -> BlockLoot.createSingleItemTableWithSilkTouch(block, Blocks.DIRT));
        this.add(Blocks.MYCELIUM, block -> BlockLoot.createSingleItemTableWithSilkTouch(block, Blocks.DIRT));
        this.add(Blocks.TUBE_CORAL_BLOCK, block -> BlockLoot.createSingleItemTableWithSilkTouch(block, Blocks.DEAD_TUBE_CORAL_BLOCK));
        this.add(Blocks.BRAIN_CORAL_BLOCK, block -> BlockLoot.createSingleItemTableWithSilkTouch(block, Blocks.DEAD_BRAIN_CORAL_BLOCK));
        this.add(Blocks.BUBBLE_CORAL_BLOCK, block -> BlockLoot.createSingleItemTableWithSilkTouch(block, Blocks.DEAD_BUBBLE_CORAL_BLOCK));
        this.add(Blocks.FIRE_CORAL_BLOCK, block -> BlockLoot.createSingleItemTableWithSilkTouch(block, Blocks.DEAD_FIRE_CORAL_BLOCK));
        this.add(Blocks.HORN_CORAL_BLOCK, block -> BlockLoot.createSingleItemTableWithSilkTouch(block, Blocks.DEAD_HORN_CORAL_BLOCK));
        this.add(Blocks.CRIMSON_NYLIUM, block -> BlockLoot.createSingleItemTableWithSilkTouch(block, Blocks.NETHERRACK));
        this.add(Blocks.WARPED_NYLIUM, block -> BlockLoot.createSingleItemTableWithSilkTouch(block, Blocks.NETHERRACK));
        this.add(Blocks.BOOKSHELF, block -> BlockLoot.createSingleItemTableWithSilkTouch(block, Items.BOOK, ConstantIntValue.exactly(3)));
        this.add(Blocks.CLAY, block -> BlockLoot.createSingleItemTableWithSilkTouch(block, Items.CLAY_BALL, ConstantIntValue.exactly(4)));
        this.add(Blocks.ENDER_CHEST, block -> BlockLoot.createSingleItemTableWithSilkTouch(block, Blocks.OBSIDIAN, ConstantIntValue.exactly(8)));
        this.add(Blocks.SNOW_BLOCK, block -> BlockLoot.createSingleItemTableWithSilkTouch(block, Items.SNOWBALL, ConstantIntValue.exactly(4)));
        ...
        this.add(Blocks.BLACK_BED, block -> BlockLoot.createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.BLUE_BED, block -> BlockLoot.createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.BROWN_BED, block -> BlockLoot.createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.CYAN_BED, block -> BlockLoot.createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.GRAY_BED, block -> BlockLoot.createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.GREEN_BED, block -> BlockLoot.createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.LIGHT_BLUE_BED, block -> BlockLoot.createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.LIGHT_GRAY_BED, block -> BlockLoot.createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.LIME_BED, block -> BlockLoot.createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.MAGENTA_BED, block -> BlockLoot.createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.PURPLE_BED, block -> BlockLoot.createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.ORANGE_BED, block -> BlockLoot.createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.PINK_BED, block -> BlockLoot.createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.RED_BED, block -> BlockLoot.createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.WHITE_BED, block -> BlockLoot.createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.YELLOW_BED, block -> BlockLoot.createSinglePropConditionTable(block, BedBlock.PART, BedPart.HEAD));
        this.add(Blocks.LILAC, block -> BlockLoot.createSinglePropConditionTable(block, DoublePlantBlock.HALF, DoubleBlockHalf.LOWER));
        this.add(Blocks.SUNFLOWER, block -> BlockLoot.createSinglePropConditionTable(block, DoublePlantBlock.HALF, DoubleBlockHalf.LOWER));
        this.add(Blocks.PEONY, block -> BlockLoot.createSinglePropConditionTable(block, DoublePlantBlock.HALF, DoubleBlockHalf.LOWER));
        this.add(Blocks.ROSE_BUSH, block -> BlockLoot.createSinglePropConditionTable(block, DoublePlantBlock.HALF, DoubleBlockHalf.LOWER));
        ...
        this.add(Blocks.PLAYER_HEAD, block -> LootTable.lootTable().withPool(BlockLoot.applyExplosionCondition(block, LootPool.lootPool().setRolls(ConstantIntValue.exactly(1)).add((LootPoolEntryContainer.Builder<?>)LootItem.lootTableItem(block).apply(CopyNbtFunction.copyData(CopyNbtFunction.DataSource.BLOCK_ENTITY).copy("SkullOwner", "SkullOwner"))))));
        this.add(Blocks.BEE_NEST, BlockLoot::createBeeNestDrop);
        this.add(Blocks.BEEHIVE, BlockLoot::createBeeHiveDrop);
        this.add(Blocks.BIRCH_LEAVES, block -> BlockLoot.createLeavesDrops(block, Blocks.BIRCH_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
        this.add(Blocks.ACACIA_LEAVES, block -> BlockLoot.createLeavesDrops(block, Blocks.ACACIA_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
        this.add(Blocks.JUNGLE_LEAVES, block -> BlockLoot.createLeavesDrops(block, Blocks.JUNGLE_SAPLING, JUNGLE_LEAVES_SAPLING_CHANGES));
        this.add(Blocks.SPRUCE_LEAVES, block -> BlockLoot.createLeavesDrops(block, Blocks.SPRUCE_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
        this.add(Blocks.OAK_LEAVES, block -> BlockLoot.createOakLeavesDrops(block, Blocks.OAK_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
        this.add(Blocks.DARK_OAK_LEAVES, block -> BlockLoot.createOakLeavesDrops(block, Blocks.DARK_OAK_SAPLING, NORMAL_LEAVES_SAPLING_CHANCES));
        ...
        this.add(Blocks.SWEET_BERRY_BUSH, block -> BlockLoot.applyExplosionDecay(block, LootTable.lootTable().withPool(LootPool.lootPool().when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.SWEET_BERRY_BUSH).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SweetBerryBushBlock.AGE, 3))).add(LootItem.lootTableItem(Items.SWEET_BERRIES)).apply(SetItemCountFunction.setCount(RandomValueBounds.between(2.0f, 3.0f))).apply(ApplyBonusCount.addUniformBonusCount(Enchantments.BLOCK_FORTUNE))).withPool(LootPool.lootPool().when(LootItemBlockStatePropertyCondition.hasBlockStateProperties(Blocks.SWEET_BERRY_BUSH).setProperties(StatePropertiesPredicate.Builder.properties().hasProperty(SweetBerryBushBlock.AGE, 2))).add(LootItem.lootTableItem(Items.SWEET_BERRIES)).apply(SetItemCountFunction.setCount(RandomValueBounds.between(1.0f, 2.0f))).apply(ApplyBonusCount.addUniformBonusCount(Enchantments.BLOCK_FORTUNE)))));
        this.add(Blocks.BROWN_MUSHROOM_BLOCK, block -> BlockLoot.createMushroomBlockDrop(block, Blocks.BROWN_MUSHROOM));
        this.add(Blocks.RED_MUSHROOM_BLOCK, block -> BlockLoot.createMushroomBlockDrop(block, Blocks.RED_MUSHROOM));
        this.add(Blocks.COAL_ORE, block -> BlockLoot.createOreDrop(block, Items.COAL));
        this.add(Blocks.EMERALD_ORE, block -> BlockLoot.createOreDrop(block, Items.EMERALD));
        this.add(Blocks.NETHER_QUARTZ_ORE, block -> BlockLoot.createOreDrop(block, Items.QUARTZ));
        this.add(Blocks.DIAMOND_ORE, block -> BlockLoot.createOreDrop(block, Items.DIAMOND));
        this.add(Blocks.NETHER_GOLD_ORE, block -> BlockLoot.createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)BlockLoot.applyExplosionDecay(block, ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.GOLD_NUGGET).apply(SetItemCountFunction.setCount(RandomValueBounds.between(2.0f, 6.0f)))).apply(ApplyBonusCount.addOreBonusCount(Enchantments.BLOCK_FORTUNE)))));
        this.add(Blocks.LAPIS_ORE, block -> BlockLoot.createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)BlockLoot.applyExplosionDecay(block, ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.LAPIS_LAZULI).apply(SetItemCountFunction.setCount(RandomValueBounds.between(4.0f, 9.0f)))).apply(ApplyBonusCount.addOreBonusCount(Enchantments.BLOCK_FORTUNE)))));
        this.add(Blocks.COBWEB, block -> BlockLoot.createSilkTouchOrShearsDispatchTable(block, (LootPoolEntryContainer.Builder)BlockLoot.applyExplosionCondition(block, LootItem.lootTableItem(Items.STRING))));
        this.add(Blocks.DEAD_BUSH, block -> BlockLoot.createShearsDispatchTable(block, (LootPoolEntryContainer.Builder)BlockLoot.applyExplosionDecay(block, LootItem.lootTableItem(Items.STICK).apply(SetItemCountFunction.setCount(RandomValueBounds.between(0.0f, 2.0f))))));
        ...
        this.add(Blocks.LARGE_FERN, block -> BlockLoot.createDoublePlantWithSeedDrops(block, Blocks.FERN));
        this.add(Blocks.TALL_GRASS, block -> BlockLoot.createDoublePlantWithSeedDrops(block, Blocks.GRASS));
        this.add(Blocks.MELON_STEM, block -> BlockLoot.createStemDrops(block, Items.MELON_SEEDS));
        this.add(Blocks.ATTACHED_MELON_STEM, block -> BlockLoot.createAttachedStemDrops(block, Items.MELON_SEEDS));
        this.add(Blocks.PUMPKIN_STEM, block -> BlockLoot.createStemDrops(block, Items.PUMPKIN_SEEDS));
        this.add(Blocks.ATTACHED_PUMPKIN_STEM, block -> BlockLoot.createAttachedStemDrops(block, Items.PUMPKIN_SEEDS));
        ...
        this.add(Blocks.GRAVEL, block -> BlockLoot.createSilkTouchDispatchTable(block, BlockLoot.applyExplosionCondition(block, ((LootPoolSingletonContainer.Builder)LootItem.lootTableItem(Items.FLINT).when(BonusLevelTableCondition.bonusLevelFlatChance(Enchantments.BLOCK_FORTUNE, 0.1f, 0.14285715f, 0.25f, 1.0f))).otherwise(LootItem.lootTableItem(block)))));
        this.add(Blocks.CAMPFIRE, block -> BlockLoot.createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)BlockLoot.applyExplosionCondition(block, LootItem.lootTableItem(Items.CHARCOAL).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(2))))));
        this.add(Blocks.GILDED_BLACKSTONE, block -> BlockLoot.createSilkTouchDispatchTable(block, BlockLoot.applyExplosionCondition(block, ((LootPoolSingletonContainer.Builder)((LootPoolEntryContainer.Builder)LootItem.lootTableItem(Items.GOLD_NUGGET).apply(SetItemCountFunction.setCount(RandomValueBounds.between(2.0f, 5.0f)))).when(BonusLevelTableCondition.bonusLevelFlatChance(Enchantments.BLOCK_FORTUNE, 0.1f, 0.14285715f, 0.25f, 1.0f))).otherwise(LootItem.lootTableItem(block)))));
        this.add(Blocks.SOUL_CAMPFIRE, block -> BlockLoot.createSilkTouchDispatchTable(block, (LootPoolEntryContainer.Builder)BlockLoot.applyExplosionCondition(block, LootItem.lootTableItem(Items.SOUL_SOIL).apply(SetItemCountFunction.setCount(ConstantIntValue.exactly(1))))));
    ...
    public void dropPottedContents(Block block2) {
        this.add(block2, block -> BlockLoot.createPotFlowerItemTable(((FlowerPotBlock)block).getContent()));
    }
