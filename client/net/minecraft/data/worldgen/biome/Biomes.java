...
public abstract class Biomes {
    ...
    private static Biome register(int n, ResourceKey<Biome> resourceKey, Biome biome) {
        TO_NAME.put(n, resourceKey);
        return BuiltinRegistries.registerMapping(BuiltinRegistries.BIOME, n, resourceKey, biome);
    }

    public static ResourceKey<Biome> byId(int n) {
        return (ResourceKey)TO_NAME.get(n);
    }
