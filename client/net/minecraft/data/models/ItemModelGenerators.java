...
public class ItemModelGenerators {
    ...
    public void run() {
        ...
        for (n = 1; n < 64; ++n) {
            this.generateFlatItem(Items.CLOCK, String.format("_%02d", n), ModelTemplates.FLAT_ITEM);
        }
        ...
        for (n = 0; n < 32; ++n) {
            if (n == 16) continue;
            this.generateFlatItem(Items.COMPASS, String.format("_%02d", n), ModelTemplates.FLAT_ITEM);
        }
