...
implements NeutralMob {
    ...
    public void aiStep() {
        ...
        if (IronGolem.getHorizontalDistanceSqr(this.getDeltaMovement()) > 2.500000277905201E-7 && this.random.nextInt(5) == 0 && !(blockState = this.level.getBlockState(new BlockPos(n2 = Mth.floor(this.getX()), n = Mth.floor(this.getY() - 0.20000000298023224), n3 = Mth.floor(this.getZ())))).isAir()) {
    ...
    public boolean doHurtTarget(Entity entity) {
        ...
        boolean bl = entity.hurt(DamageSource.mobAttack(this), f2);
        if (bl) {
