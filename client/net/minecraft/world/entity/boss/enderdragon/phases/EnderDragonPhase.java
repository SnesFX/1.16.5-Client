...
public class EnderDragonPhase<T extends DragonPhaseInstance> {
    ...
    private EnderDragonPhase(int n, Class<? extends DragonPhaseInstance> class_, String string) {
        this.id = n;
    ...
    public static EnderDragonPhase<?> getById(int n) {
        if (n < 0 || n >= phases.length) {
