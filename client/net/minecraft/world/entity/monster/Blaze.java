        ...
        public void tick() {
            ...
            if (d < 4.0) {
                ...
                if (this.attackTime <= 0) {
                    ...
                    if (this.attackStep > 1) {
                        float f = Mth.sqrt(Mth.sqrt(d)) * 0.5f;
                        if (!this.blaze.isSilent()) {
                            this.blaze.level.levelEvent(null, 1018, this.blaze.blockPosition(), 0);
                        }
                        for (int i = 0; i < 1; ++i) {
                            SmallFireball smallFireball = new SmallFireball(this.blaze.level, this.blaze, d2 + this.blaze.getRandom().nextGaussian() * (double)f, d3, d4 + this.blaze.getRandom().nextGaussian() * (double)f);
