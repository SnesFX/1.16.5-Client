...
public interface RecipeSerializer<T extends Recipe<?>> {
    ...
    public static final SimpleCookingSerializer<SmeltingRecipe> SMELTING_RECIPE = RecipeSerializer.register("smelting", new SimpleCookingSerializer<SmeltingRecipe>((arg_0, arg_1, arg_2, arg_3, arg_4, arg_5) -> SmeltingRecipe.new(arg_0, arg_1, arg_2, arg_3, arg_4, arg_5), 200));
    public static final SimpleCookingSerializer<BlastingRecipe> BLASTING_RECIPE = RecipeSerializer.register("blasting", new SimpleCookingSerializer<BlastingRecipe>((arg_0, arg_1, arg_2, arg_3, arg_4, arg_5) -> BlastingRecipe.new(arg_0, arg_1, arg_2, arg_3, arg_4, arg_5), 100));
    public static final SimpleCookingSerializer<SmokingRecipe> SMOKING_RECIPE = RecipeSerializer.register("smoking", new SimpleCookingSerializer<SmokingRecipe>((arg_0, arg_1, arg_2, arg_3, arg_4, arg_5) -> SmokingRecipe.new(arg_0, arg_1, arg_2, arg_3, arg_4, arg_5), 100));
    public static final SimpleCookingSerializer<CampfireCookingRecipe> CAMPFIRE_COOKING_RECIPE = RecipeSerializer.register("campfire_cooking", new SimpleCookingSerializer<CampfireCookingRecipe>((arg_0, arg_1, arg_2, arg_3, arg_4, arg_5) -> CampfireCookingRecipe.new(arg_0, arg_1, arg_2, arg_3, arg_4, arg_5), 100));
    public static final RecipeSerializer<StonecutterRecipe> STONECUTTER = RecipeSerializer.register("stonecutting", new SingleItemRecipe.Serializer<StonecutterRecipe>((arg_0, arg_1, arg_2, arg_3) -> StonecutterRecipe.new(arg_0, arg_1, arg_2, arg_3)));
