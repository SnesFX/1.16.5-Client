...
public class Scoreboard {
    ...
    public Map<Objective, Score> getPlayerScores(String string) {
        HashMap hashMap = this.playerScores.get(string);
        if (hashMap == null) {
    ...
    public void setDisplayObjective(int n, @Nullable Objective objective) {
        this.displayObjectives[n] = objective;
    }

    @Nullable
    public Objective getDisplayObjective(int n) {
        return this.displayObjectives[n];
    }
    ...
    public static String getDisplaySlotName(int n) {
        ...
        if (n >= 3 && n <= 18 && (chatFormatting = ChatFormatting.getById(n - 3)) != null && chatFormatting != ChatFormatting.RESET) {
