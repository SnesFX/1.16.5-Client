...
public class LootContext {
    ...
    public static class Builder {
        ...
        public LootContext create(LootContextParamSet lootContextParamSet) {
            ...
            if (!setView.isEmpty()) {
                throw new IllegalArgumentException("Parameters not allowed in this parameter set: " + (Object)setView);
            }
            Sets.SetView setView2 = Sets.difference(lootContextParamSet.getRequired(), this.params.keySet());
            if (!setView2.isEmpty()) {
                throw new IllegalArgumentException("Missing required parameters: " + (Object)setView2);
            }
