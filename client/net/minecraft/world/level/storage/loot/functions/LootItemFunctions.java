...
public class LootItemFunctions {
    ...
    public static BiFunction<ItemStack, LootContext, ItemStack> compose(BiFunction<ItemStack, LootContext, ItemStack>[] arrbiFunction) {
        switch (arrbiFunction.length) {
            case 0: {
                return IDENTITY;
            }
            case 1: {
                return arrbiFunction[0];
            }
            case 2: {
                BiFunction<ItemStack, LootContext, ItemStack> biFunction = arrbiFunction[0];
                BiFunction<ItemStack, LootContext, ItemStack> biFunction2 = arrbiFunction[1];
        ...
        return (itemStack, lootContext) -> {
            for (BiFunction biFunction : arrbiFunction) {
