...
public final class Material {
    public static final Material AIR = Builder.access$000(new Builder(MaterialColor.NONE).noCollider()).nonSolid().replaceable().build();
    public static final Material STRUCTURAL_AIR = Builder.access$000(new Builder(MaterialColor.NONE).noCollider()).nonSolid().replaceable().build();
    public static final Material PORTAL = Builder.access$000(new Builder(MaterialColor.NONE).noCollider()).nonSolid().notPushable().build();
    public static final Material CLOTH_DECORATION = Builder.access$000(new Builder(MaterialColor.WOOL).noCollider()).nonSolid().flammable().build();
    public static final Material PLANT = Builder.access$000(new Builder(MaterialColor.PLANT).noCollider()).nonSolid().destroyOnPush().build();
    public static final Material WATER_PLANT = Builder.access$000(new Builder(MaterialColor.WATER).noCollider()).nonSolid().destroyOnPush().build();
    public static final Material REPLACEABLE_PLANT = Builder.access$000(new Builder(MaterialColor.PLANT).noCollider()).nonSolid().destroyOnPush().replaceable().flammable().build();
    public static final Material REPLACEABLE_FIREPROOF_PLANT = Builder.access$000(new Builder(MaterialColor.PLANT).noCollider()).nonSolid().destroyOnPush().replaceable().build();
    public static final Material REPLACEABLE_WATER_PLANT = Builder.access$000(new Builder(MaterialColor.WATER).noCollider()).nonSolid().destroyOnPush().replaceable().build();
    public static final Material WATER = Builder.access$000(new Builder(MaterialColor.WATER).noCollider()).nonSolid().destroyOnPush().replaceable().liquid().build();
    public static final Material BUBBLE_COLUMN = Builder.access$000(new Builder(MaterialColor.WATER).noCollider()).nonSolid().destroyOnPush().replaceable().liquid().build();
    public static final Material LAVA = Builder.access$000(new Builder(MaterialColor.FIRE).noCollider()).nonSolid().destroyOnPush().replaceable().liquid().build();
    public static final Material TOP_SNOW = Builder.access$000(new Builder(MaterialColor.SNOW).noCollider()).nonSolid().destroyOnPush().replaceable().build();
    public static final Material FIRE = Builder.access$000(new Builder(MaterialColor.NONE).noCollider()).nonSolid().destroyOnPush().replaceable().build();
    public static final Material DECORATION = Builder.access$000(new Builder(MaterialColor.NONE).noCollider()).nonSolid().destroyOnPush().build();
    public static final Material WEB = Builder.access$000(new Builder(MaterialColor.WOOL).noCollider()).destroyOnPush().build();
    ...
    public static final Material EXPLOSIVE = Builder.access$000(new Builder(MaterialColor.FIRE).flammable()).build();
    public static final Material LEAVES = Builder.access$000(new Builder(MaterialColor.PLANT).flammable()).destroyOnPush().build();
    public static final Material GLASS = Builder.access$000(new Builder(MaterialColor.NONE)).build();
    public static final Material ICE = Builder.access$000(new Builder(MaterialColor.ICE)).build();
    public static final Material CACTUS = Builder.access$000(new Builder(MaterialColor.PLANT)).destroyOnPush().build();
    ...
    public static class Builder {
        ...
        static /* synthetic */ Builder access$000(Builder builder) {
