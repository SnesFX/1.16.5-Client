...
public class MaterialColor {
    ...
    private MaterialColor(int n, int n2) {
        ...
        this.id = n;
        this.col = n2;
        MaterialColor.MATERIAL_COLORS[n] = this;
    }
    ...
    public int calculateRGBColor(int n) {
        ...
        int n3 = (this.col >> 16 & 0xFF) * n2 / 255;
        int n4 = (this.col >> 8 & 0xFF) * n2 / 255;
        int n5 = (this.col & 0xFF) * n2 / 255;
        return 0xFF000000 | n5 << 16 | n4 << 8 | n3;
    }
}
