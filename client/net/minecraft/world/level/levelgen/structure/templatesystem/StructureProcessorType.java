...
public interface StructureProcessorType<P extends StructureProcessor> {
    ...
    public static final Codec<StructureProcessorList> DIRECT_CODEC = Codec.either((Codec)LIST_OBJECT_CODEC.fieldOf("processors").codec(), LIST_OBJECT_CODEC).xmap(either -> (StructureProcessorList)either.map(structureProcessorList -> structureProcessorList, structureProcessorList -> structureProcessorList), Either::left);
