...
public abstract class SurfaceBuilder<C extends SurfaceBuilderConfiguration> {
    ...
    private static <C extends SurfaceBuilderConfiguration, F extends SurfaceBuilder<C>> F register(String string, F f) {
        return (F)Registry.register(Registry.SURFACE_BUILDER, string, f);
    }

    public SurfaceBuilder(Codec<C> codec) {
        this.configuredCodec = codec.fieldOf("config").xmap(this::configured, ConfiguredSurfaceBuilder::config).codec();
    }
    ...
    public ConfiguredSurfaceBuilder<C> configured(C c) {
