...
public class GameTestInfo {
    ...
    public void spawnStructure(BlockPos blockPos, int n) {
        StructureBlockEntity structureBlockEntity = StructureUtils.spawnStructure(this.getStructureName(), blockPos, this.getRotation(), n, this.level, false);
