...
public enum OctahedralGroup implements StringRepresentable
{
    ...
    static {
        cayleyTable = Util.make(new OctahedralGroup[OctahedralGroup.values().length][OctahedralGroup.values().length], arroctahedralGroup -> {
            ...
            for (OctahedralGroup octahedralGroup2 : OctahedralGroup.values()) {
                for (OctahedralGroup octahedralGroup3 : OctahedralGroup.values()) {
                    ...
                    arroctahedralGroup[octahedralGroup2.ordinal()][octahedralGroup3.ordinal()] = map.get((Object)Pair.of((Object)((Object)symmetricGroup3), (Object)booleanArrayList));
                }
            }
        });
        inverseTable = (OctahedralGroup[])Arrays.stream(OctahedralGroup.values()).map(octahedralGroup -> Arrays.stream(OctahedralGroup.values()).filter(octahedralGroup2 -> octahedralGroup.compose((OctahedralGroup)octahedralGroup2) == IDENTITY).findAny().get()).toArray(n -> new OctahedralGroup[n]);
    }
